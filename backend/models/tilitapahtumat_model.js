...
const tilitapahtumat = {
  getById: function(id, callback) {
    return db.query('SELECT idTilitapahtumat, tilinumero, date_format(tilitapahtuma_pvm, "%d.%m.%Y") as "pvm", selite, summa FROM tilitapahtumat where idTilitapahtumat=? order by idTilitapahtumat desc limit 10', [id], callback);
  },
